...
plot(1:Nlags, (reg_results(:, 1, 1))/5, '-','LineWidth',2,'Color',colors_list{1})
plot(1:Nlags, (reg_results(:, 1, 2)), '-.','LineWidth',2,'Color',colors_list{3})
plot(1:Nlags, (reg_results(:, 1, 3)), '--','LineWidth',2,'Color',colors_list{2})
